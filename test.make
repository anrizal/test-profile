...
;libraries[chosen][download][url] = https://github.com/harvesthq/chosen/releases/download/v1.4.2/chosen_v1.4.2.zip
;libraries[chosen][destination] = libraries


;PERFORMACE MODULE
;The Speedy module is designed to help speed up front end performance in a site.
;In this first release of the Speedy module it provides minified versions of core JavaScript files that are not already minified.
projects[speedy][type] = module
projects[speedy][version] = 1.19
